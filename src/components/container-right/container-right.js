  ...
  return (
    <div className="container-right">
      <div className="events" ref={scrollToEvents} style={themeStyle}>
        {/* { state.signin.user && !state.events.length ? <img loading="lazy" className='add' src={ADD} alt='add' /> : '' } */}
        <label>
          {state.events.length ? (
            <>
              <div>Events</div>
      ...
      <div className="news" ref={scrollToNews} style={themeStyle}>
        {/* { state.signin.user && !state.headlines.length ? <img loading="lazy" className='add' src={ADD} alt='add' /> : '' } */}
        <label>
      ...
      <div className="gallery" ref={scrollToPosters}>
        ...
        {index < postersLength - 1 && (
          <div className="right" onClick={() => setIndex(index + 1)}>
            {">"}
          </div>
        )}
      ...
      <div className="gallery" ref={scrollToVideos}>
        ...
        {indexVideo < videosLength - 1 && (
          <div className="right" onClick={() => setIndexVideo(indexVideo + 1)}>
            {">"}
          </div>
        )}
        <div className="gallery-images" style={{ border: state.themes.find((theme) => theme.id === state.theme).border }}>

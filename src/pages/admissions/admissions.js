...
const Admissions = () => {
  return (
    <>
      ...
      <p>Students can enroll into our Coaching by collecting the "Registration form" from our academy. Registration is confirmed soon after the payment is confirmed.</p>

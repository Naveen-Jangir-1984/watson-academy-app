  ...
  return (
    <>
      ...
      <div>
        ...
        <p>Presentation of the subjects is in a systematic and logical manner to enable the students to comprehend the structure and substance of the concepts.</p>
        <p>Concentration on exam-oriented appreciable number of quadivty problems to provide a firm grounding for students in various subjects and to face the professional exams with high confidence.</p>
      </div>
      ...
      <div className='container-left-top'>
        ...
        >
          <img loading="lazy" src={instruction.logo} style={{width: '20px', height: '20px'}} alt='placeholder' />
          <div>{instruction.name}</div>
        </div>)}
      </div>
      <div className='slider' style={{ display: selectedInstruction.length ? 'flex' : 'none' }}>
        <img loading="lazy" className='slider-close' src={`${uri}:${port}/images/close.png`} alt='close' onClick={() => dispatch({type: 'DESELECT_INSTRUCTION'})} />
      ...
      <div>
        ...
        <p>
          ...
          <b>Regular tests</b> are designed for the students to understand the stress and time-pressure conditions which expected to be faced in the actual examinations.
        </p>
        <p>
          <b>Well paced lectures</b> starting with basic concepts and gradually culminating in entrance level problems. Continuous <b>Feedback Mechanism</b> in place so as to improve on any shortcomings whatsoever as soon as possible. Result oriented and dedicated faculty well equipped with knowledge regarding the subjects. Stringent
          <b>selection criteria for faculty</b> so as to give the best to the students. We customize each subject learning objectives depending on the learning gaps of the student and plan a lesson structure that would complement their individual needs.
        </p>
      </div>
    </>
  );
